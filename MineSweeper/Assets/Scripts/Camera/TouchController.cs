    ...
    void Update()
    {
        ...
        if (Input.touchCount == 2)
        {
            ...
            else
            {
                ...
                float newOrtSize = initialOrthographicSize / scaleFactor;
                //EventController.Instance.ChangeOrtoSize(newOrtSize);

                if(timeRemaining <= 0)
                {
                    timeRemaining = 1f;
                    camera.orthographicSize = newOrtSize;
                }
